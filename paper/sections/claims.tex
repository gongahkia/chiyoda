...
The final row is deliberately open. The regime robustness study in
\S\ref{sec:robustness-plan} is designed to decide whether the primary policy
ordering is a stable property of the simulator or a property of the initial
station--hazard--population regime. Until that grid is complete, the paper
should make strong claims about the existence and measurability of
information-safety tradeoffs, but only conditional claims about which policy
should be preferred operationally.
