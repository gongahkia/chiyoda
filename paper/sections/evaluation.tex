...
The empirical package supports four paper-level claims. First, emergency
...
messages are safe by default. Any future LLM-mediated messaging layer should
therefore be evaluated as a constrained control policy with bounded action
space, auditable message templates, and the same ISE and HCI tests used here,
not as an unconstrained source of evacuation advice.
