...
useful even if it does not maximize raw evacuation count. It also gives a
natural standard for generated-language guidance: an LLM message is only useful
if it remains bounded, replayable, validated, and beneficial under the same ISE
and HCI diagnostics as deterministic messages.
