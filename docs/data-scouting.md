...
| [Interweaving collision-avoidance trajectories](https://datadryad.org/dataset/doi%3A10.5061/dryad.c2fqz619v) | Dryad metadata exposes one 3.69 MB ZIP and CC0 metadata | pending acquisition | Nine controlled outdoor interweaving trials contain 25 Hz head trajectories and published normal-walking/avoidance-strategy labels. The archive's disjoint trial members could support a narrow local-avoidance protocol only after the raw ZIP and every member are independently content-locked. On 2026-09-06 this environment received HTTP 401 from Dryad's file-download endpoint, so no catalog, fit, or empirical claim is checked in. |
